...
torchrun --nproc_per_node=8 \
    ...
    --version v1 \
    --data_path /mnt/csi-data-aly/shared/public/haozhou/data/KaiChen1998/coda-lm-llava-format/ \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-task-hop-coda-lm \
    --exp_name llava-v1.5-7b-task-hop-coda-lm \
    --num_train_epochs 3 \
